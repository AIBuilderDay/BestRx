  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-[470px] animate-[sheetIn_0.45s_cubic-bezier(0.2,0.7,0.2,1)_both] rounded-2xl border border-ink bg-surface p-5.5"
      >
        ...
        <input
          ...
          className="my-4 w-full rounded-lg border border-line bg-bg px-3 py-2.5 text-[13px] text-ink focus:border-ink focus:outline-none"
        />
