  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-[470px] animate-[sheetIn_0.45s_cubic-bezier(0.2,0.7,0.2,1)_both] rounded-2xl border border-[var(--color-ink)] bg-white p-5.5"
      >
        ...
        <input
          ...
          className="my-4 w-full rounded-lg border border-[var(--color-line)] px-3 py-2.5 text-[13px] focus:border-[var(--color-ink)] focus:outline-none"
        />
          ...
          {filtered.map((p) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => toggle(p.id)}
                className={`flex items-center gap-2.5 rounded-lg px-2.5 py-2.5 text-left transition-colors hover:bg-neutral-100 ${on ? 'bg-neutral-100' : ''}`}
              >
                <span
                ...
                >
                  <span className={`text-[9px] leading-none text-white ${on ? 'scale-100' : 'scale-0'} transition-transform`}>✓</span>
                </span>
                ...
                {owns && (
                  <span className="ml-auto flex-none rounded-full bg-[var(--color-ink)] px-2 py-1 text-[8.5px] uppercase tracking-wide text-white">
        ...
        <button
          ...
          className="mt-4 w-full border border-[var(--color-ink)] bg-[var(--color-ink)] py-3.5 text-[11px] uppercase tracking-[0.1em] text-white transition-opacity hover:opacity-85"
        >
          {confirmLabel}
        </button>
      </div>
