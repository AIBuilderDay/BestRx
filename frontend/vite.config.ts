  ...
  build: {
    rollupOptions: {
      input: {
        ...
        // The service worker is TypeScript (CLAUDE.md bans hand-written .js), so it is built rather
        // than dropped into public/. It must land at the site root: a worker can only control pages
        // at or below its own path.
